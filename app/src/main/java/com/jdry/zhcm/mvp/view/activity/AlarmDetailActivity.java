...
public class AlarmDetailActivity extends SjmBaseActivity {
    ...
    public void goDaoHang() {
        if (isLocateSuccess) {
            ...
            waitingDialog = new ProgressDialog(AlarmDetailActivity.this);
    ...
    protected void onCreateByMe(Bundle savedInstanceState) {
        setTopBar(this, tvTopBarTitle, "告警", rtvTopBarBack);
        initData();
    }
    ...
    private void initData() {
        alarmBean = (AlarmBean) getIntent().getSerializableExtra("bean");
        if (alarmBean == null) {
            return;
        }
        tvId.setText(alarmBean.getDeviceNo());
        tvDevName.setText(alarmBean.getDeviceName() + "-" + alarmBean.getPhaseName());
        tvX.setText(alarmBean.getDeviceX() + "");
        tvY.setText(alarmBean.getDeviceY() + "");
        tvDevPerson.setText(alarmBean.getUserName());
        tvPersonPhone.setText(alarmBean.getPhone());
        tvAlarmTime.setText(JdryTime.getDayHourMinSec(alarmBean.getAlertTime()));

        String coords = alarmBean.getDeviceX() + "," + alarmBean.getDeviceY();
        ...
        new ActionSheet.Builder(this, getSupportFragmentManager())
                ...
                .setListener(new ActionSheet.ActionSheetListener() {
                    ...
                    public void onOtherButtonClick(ActionSheet actionSheet, int index) {
                        switch (index) {
                            case 0:
                                OpenClientUtil.getLatestBaiduMapApp(AlarmDetailActivity.this);
                                break;
                            case 1:
                                startWebNavi(para);
                                break;
