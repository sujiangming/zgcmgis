...
public class ViewHolder
{
	...
	public ViewHolder setImageResource(int viewId,int default_img, String url)
	{
		ImageView view = getView(viewId);
		return this;
	}

	public ViewHolder setBackGround(int viewId, String url)
	{
	...
	public ViewHolder setBackgroundRes(int viewId, Bitmap bitmap)
	{
		View view = getView(viewId);
	...
	public ViewHolder setTextSizeSP(int viewId, int size)
	{
		TextView view = getView(viewId);
